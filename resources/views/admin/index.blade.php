	...
	<div class="modal-content">
	  ...
	  <div class="modal-body">
	  	<form action="{{route('preguntas.store')}}" id="form-add" method="post">
	  		...
	  		<input id="title" class="form-control" type="text" name="question" placeholder="Titulo de la Pregunta">

	  		<div class="form-group">
	  			<label for="type">Tipo</label>
		  		<select id="type" class="form-control" name="type">
		  			<option value="radio">Seleccion Simple</option>
		  			<option value="text">Parrafo</option>
		  		</select>
	  		</div>

	  		<label for="details">Descripcion</label>
	  		<textarea id="details" class="form-control" type="text" name="text" placeholder="Detalles o descripcion de la Pregunta"></textarea>
